...
export function CreateProjectCard(props: ProjectCardProps): JSX.Element {
    ...
    return (
        <div className="flex justify-center items-center p-3 w-[90%] h-52 bg-opacity-30 bg-slate-500 rounded-lg">
            <div className="flex justify-center items-center cursor-pointer w-full h-full" onClick={() => { setOpenCreateProjectDialog(true) }}>
